...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'h-screen sticky top-0 flex flex-col border-r border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900 transition-all duration-200',
    ...
    >
      <div className="flex items-center justify-between p-4">
        {!sidebarCollapsed && (
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-xl bg-primary-600 text-white flex items-center justify-center text-sm font-bold">B</div>
      ...
      <div className="px-2 mb-2">
        {!sidebarCollapsed ? (
          <div className="relative">
            ...
            <input
              placeholder="Search"
              className="w-full pl-9 pr-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-sm outline-none focus:ring-2 focus:ring-primary-500/50 dark:text-slate-200"
            />
          </div>
        ) : (
          <button className="w-full flex justify-center p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-500">
      ...
      <div className="p-3 border-t border-slate-200/60 dark:border-slate-800">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center text-xs font-semibold text-slate-600 dark:text-slate-300">
            JD
          </div>
          {!sidebarCollapsed && (
